  ...
  return (
    <div className="sticky top-0 h-screen flex items-center justify-center px-6">
      <motion.div
        ...
        className="relative w-full max-w-6xl h-[75vh] min-h-[500px] bg-[#F9F6E5] rounded-[32px] border border-[#D6DBD4]/20 overflow-hidden shadow-2xl origin-top flex flex-col md:flex-row cursor-pointer transition-colors group"
      >
        {/* Left Content */}
        <div className="flex-1 p-8 md:p-14 flex flex-col justify-between">
          <div className="space-y-8 text-left">
            <div className="flex flex-wrap gap-2">
              {project.skills.map(id => (
                <SkillTag key={id} id={id} label={getSkillLabel(id)} className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#003057]/60 hover:text-[#003057]" />
              ))}
            </div>
            <div className="space-y-4">
              <h3 className="text-4xl md:text-6xl font-bold text-[#003057] tracking-tighter leading-none">
                {project.title}
              </h3>
              <p className="text-[#003057]/70 text-lg md:text-xl leading-relaxed max-w-md font-light line-clamp-3">
                {project.description}
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6">
            ...
            {project.github && (
              <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#003057]/40 group-hover:text-[#003057] transition-colors">
